...
print (color.BOLD + color.UNDERLINE + "Let's play a quick game of Guess the Number!" + color.END)
time.sleep(0.5)
print ("")
print (color.UNDERLINE + "You have to match the number that I am thinking of!" + color.END)
time.sleep(1.5)
print ("")
print (color.UNDERLINE + "You have 3 lives! Answer wrong and you lose a life!" + color.END)
print ("")
time.sleep(1.5)
print ("")
time.sleep(1)
